            ...
            <div className="relative bg-white rounded-3xl p-4 shadow-sm border border-violet-50">
              ...
              <div className="absolute bottom-2 left-2 flex gap-1 bg-violet-50/50 p-1 rounded-2xl border border-violet-100/50">
                ...
                <Button 
                  ...
                  size="icon" 
                  onClick={toggleBold}
                  className="h-10 w-10 rounded-full text-violet-600 bg-violet-50 hover:bg-violet-100 font-extrabold text-base transition-all duration-200 active:scale-90"
                  title="Bold Text"
                >
                  B
                </Button>
